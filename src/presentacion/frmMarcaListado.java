...
public class frmMarcaListado extends javax.swing.JInternalFrame {
    ...
    public frmMarcaListado(int x, int y) {
        initComponents();
    ...
    private void llenarComboBusqueda() {
        String campos[] = new marca().obtenerCamposBusqueda();
    ...
    private void filtrar() {
        try {
            int anchoColumnas[] = {150, 500};
            String alinearColumnas[] = {"C", "C"};
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(tbOpciones, javax.swing.GroupLayout.DEFAULT_SIZE, 784, Short.MAX_VALUE)
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        frmMarcaAgregarEditar obj = new frmMarcaAgregarEditar(null, true);
        obj.setTitle("Agregar Nueva Marca");
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        int codigoMarca = Integer.parseInt(tblListado.getValueAt(fila, 0).toString());

        obj.leerDatosMarca(codigoMarca);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        try {
            boolean resultado;
            marca obj = new marca();
            obj.setCodigo_marca(codigoMarca);

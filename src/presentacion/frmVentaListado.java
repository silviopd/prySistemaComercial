...
public class frmVentaListado extends javax.swing.JInternalFrame {
     ...
     */
    public frmVentaListado(int ancho, int alto) {
        initComponents();
        setSize(ancho, alto);
    ...
    private void listar() {
        try {
            ...
            ResultSet resultado = new venta().listarPorFecha(fecha1, fecha2, tipo);

            Funciones.llenarTabla(tblVentaListado, resultado);
    ...
    private void initComponents() {
        ...
        tblVentaListado = new javax.swing.JTable(){
        ...
        tblVentaListado.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tblVentaListado.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblVentaListadoMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tblVentaListado);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        frmVenta obj = new frmVenta(null, true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        int fila = this.tblVentaListado.getSelectedRow();
        ...
        int numeroCompra = Integer.parseInt(tblVentaListado.getValueAt(fila, 0).toString());
    ...
    private void tblVentaListadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblVentaListadoMouseClicked
        
        if (evt.getClickCount() == 2) {
            int fila = tblVentaListado.getSelectedRow();
            if (fila<0) {
                Funciones.mensajeError("Debe seleccionar un registro de venta", "Error");
            }
            
            numeroVenta=Integer.parseInt(tblVentaListado.getValueAt(fila, 0).toString());
            
            frmVentaDetalle obj = new frmVentaDetalle(null, true);
            obj.setTitle("Detalle de la venta");
            obj.setVisible(true);
        }
        
    }//GEN-LAST:event_tblVentaListadoMouseClicked
    ...
    private javax.swing.JTable tblVentaListado;

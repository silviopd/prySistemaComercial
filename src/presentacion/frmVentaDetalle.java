 ...
 * @author USER
 */
public class frmVentaDetalle extends javax.swing.JDialog {
      
    public frmVentaDetalle(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void listarVentaDetalle(){
        lblNumeroVenta.setText(String.valueOf(frmVentaListado.numeroVenta));
        
        try {
            ResultSet resultado = new venta().listarVentaDetalle(frmVentaListado.numeroVenta);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DETALLE DEL NUMERO DE VENTA");

        lblNumeroVenta.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lblNumeroVenta.setText("0");
